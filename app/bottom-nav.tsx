...
export default function BottomNav() {
  ...
  if (pathname.includes("/record") || pathname.includes("/settings") || pathname.includes("/hit")) return null;

  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 mx-auto max-w-[430px] border-t border-[#e3e7f0] bg-white/95 px-3 pb-[calc(8px+env(safe-area-inset-bottom))] pt-2 backdrop-blur" aria-label="주요 메뉴">
